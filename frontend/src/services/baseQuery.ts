...
import { resetTokens, setTokensOnly } from "../store/reducers/authReducer";
...
> = async (args, api, extraOptions) => {
  ...
  if (
    ...
    // Check if it's a token expired error with safe property access
    ...
    if (data) {
      ...
      api.dispatch(setTokensOnly(data));
