...
// Lazy load social login components
const AppleLogin = lazy(() => import("./AppleLogin"));
const FBLogin = lazy(() => import("./FBLogin"));
const GoogleLogin = lazy(() => import("./GoogleLogin"));
const LinkedInLogin = lazy(() => import("./LinkedInLogin"));

// Loading fallback for social components
...
export default function LoginForm() {
   ...
   * 
   * If the response is successful, the user is redirected to the appropriate dashboard based on their role.
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      // Navigation will be handled by the useEffect hook when the auth state updates
    } catch (error: any) {
