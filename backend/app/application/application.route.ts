...
import { authenticateToken, requireEmployer, requireCandidate } from "../common/middleware/auth.middleware";
 ...
 */
router.post("/", requireCandidate, ApplicationController.createApplication);
 ...
 *         description: Internal server error
 */
router.get("/candidate", requireCandidate, ApplicationController.getApplicationsByCandidate);
 ...
 *         description: Internal server error
 */
router.delete("/:applicationId/withdraw", requireCandidate, ApplicationController.withdrawApplication);
 ...
 *         description: Internal server error
 */
router.get("/employer", requireEmployer, ApplicationController.getApplicationsByEmployer);
 ...
 *         description: Internal server error
 */
router.get("/employer/stats", requireEmployer, ApplicationController.getApplicationStats);
 ...
 *         description: Internal server error
 */
router.patch("/:applicationId/status", requireEmployer, ApplicationController.updateApplicationStatus);
