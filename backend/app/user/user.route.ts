 ...
 *         description: Unauthorized
 */
router.get("/me", roleAuth(["EMPLOYER", "CANDIDATE", "ADMIN"]), userController.getUserInfo);
...
router.post(
  "/change-password",
  roleAuth(["EMPLOYER", "CANDIDATE", "ADMIN"]),
 ...
 *         description: Unauthorized
 */
router.post("/logout", roleAuth(["EMPLOYER", "CANDIDATE", "ADMIN"]), userController.logoutUser);
