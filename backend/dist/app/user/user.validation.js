...
exports.socialLogin = exports.updateUser = exports.createAdminUser = exports.refreshToken = exports.editUser = exports.updateUserBasic = exports.createUser = exports.forgotPassword = exports.verifyEmail = exports.changePassword = exports.verifyInvitation = exports.login = void 0;
...
exports.createAdminUser = (0, express_validator_1.checkExact)([
    (0, express_validator_1.body)("name")
        .notEmpty()
        .withMessage("Name is required")
        .isString()
...
exports.updateUser = (0, express_validator_1.checkExact)([
    ...
    (0, express_validator_1.body)("blocked")
        .optional()
        .isBoolean()
        .withMessage("Blocked must be a boolean value"),
]);
const socialLogin = (fieldName) => (0, express_validator_1.checkExact)([
    (0, express_validator_1.body)(fieldName)
        ...
        .isString()
        .bail()
        .withMessage(`${fieldName} must be string`),
]);
