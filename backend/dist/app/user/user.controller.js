...
exports.linkedInLogin = exports.googleLogin = exports.fbLogin = exports.appleLogin = exports.updateUserByAdmin = exports.createAdminUser = exports.refreshToken = exports.logout = exports.getUserInfo = exports.logoutUser = exports.refreshUserToken = exports.loginUser = exports.getAllUser = exports.getUserById = exports.deleteUser = exports.editUser = exports.updateUser = exports.requestResetPassword = exports.changePassword = exports.resetPassword = exports.verifyInvitation = exports.inviteUser = exports.createUser = void 0;
...
exports.createUser = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.send((0, response_hepler_1.createResponse)(result, "User created successfully"));
}));
exports.inviteUser = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield userService.createUser(Object.assign(Object.assign({}, req.body), { role: "CANDIDATE", active: false }));
    ...
    res.send((0, response_hepler_1.createResponse)(result, "User invited successfully"));
}));
...
exports.getAllUser = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const limit = req.query.limit
        ...
        : undefined;
    const result = yield userService.getAllUser({}, { skip, limit });
    if (skip || limit) {
...
exports.refreshUserToken = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { refreshToken } = req.body;
    if (!refreshToken) {
        throw (0, http_errors_1.default)(400, "Refresh token is required");
    }
    const newTokens = yield userService.refreshUserToken(refreshToken);
    if (!newTokens) {
        throw (0, http_errors_1.default)(401, "Invalid or expired refresh token");
    }
    res.send((0, response_hepler_1.createResponse)(newTokens, "Token refreshed successfully"));
}));
exports.logoutUser = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const success = yield userService.logoutUser(req.user._id);
    if (!success) {
        throw (0, http_errors_1.default)(500, "Failed to logout");
    }
    res.send((0, response_hepler_1.createResponse)(null, "Logout successful"));
}));
...
exports.createAdminUser = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield userService.createUser(Object.assign(Object.assign({}, req.body), { role: "ADMIN", active: true, provider: "manual" }));
    res.status(201).send((0, response_hepler_1.createResponse)(result, "Admin user created successfully"));
}));
exports.updateUserByAdmin = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const updateData = req.body;
    // Prevent updating critical fields
    const { password, refreshToken, provider } = updateData, safeUpdateData = __rest(updateData, ["password", "refreshToken", "provider"]);
    const result = yield userService.editUser(id, safeUpdateData);
    if (!result) {
        throw (0, http_errors_1.default)(404, "User not found");
    }
    res.send((0, response_hepler_1.createResponse)(result, "User updated successfully"));
}));
