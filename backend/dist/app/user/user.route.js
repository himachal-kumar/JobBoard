 ...
 *         description: Unauthorized
 */
router.get("/me", (0, role_auth_middleware_1.roleAuth)(["EMPLOYER", "CANDIDATE", "ADMIN"]), userController.getUserInfo);
/**
 * @swagger
 * /users/admin/me:
 *   get:
 ...
 *         description: Unauthorized
 */
router.post("/change-password", (0, role_auth_middleware_1.roleAuth)(["EMPLOYER", "CANDIDATE", "ADMIN"]), userValidator.changePassword, cath_error_middleware_1.catchError, userController.changePassword);
/**
 * @swagger
 * /users/login:
 *   post:
 ...
 */
router.post("/login", userValidator.login, cath_error_middleware_1.catchError, userController.loginUser);
/**
 * @swagger
 * /users/refresh-token:
 *   post:
 ...
 */
router.post("/refresh-token", userValidator.refreshToken, cath_error_middleware_1.catchError, userController.refreshUserToken);
/**
 * @swagger
 * /users/logout:
 *   post:
 ...
 *         description: Unauthorized
 */
router.post("/logout", (0, role_auth_middleware_1.roleAuth)(["EMPLOYER", "CANDIDATE", "ADMIN"]), userController.logoutUser);
/**
 * @swagger
 * /users/social/google:
 *   post:
